...
local botm_draw_menu = function(p_open)
    if ig.Begin("Demo: Game", p_open) then
        ...
        local skin_name_2 = string.format("game_character_skin_displayname_%s_%d", player:CharName(), 2)
        format_value("\ttranslate_string(\""..skin_name_2.."\")", game:TranslateString(skin_name_2))
